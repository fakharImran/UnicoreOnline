            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="admin_box">
                      ...
                      @endif
                      {{-- {{dd($ticket)}} --}}
                        <form method="POST" action="{{ route('tickets.update', $id) }}" novalidate  enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
...
{{-- {{dd($ticket)}} --}}
                                    <div class="user_form_content">
                                        ...
                                        <div class="user_select_form">
                                            <select id="state" name="state" class="form-select"
                                                ...
                                                <option {{($ticket['state']=='Pending Pick Up')? "selected":""}} value="Pending Pick Up">Pending Pick Up</option>
                                                <option {{($ticket['state']=='Review')? "selected":""}} value="Review">Review</option>
                                                <option {{($ticket['state']=='Updated')? "selected":""}} value="Updated">Updated</option>
                                                <option {{($ticket['state']=='Complete')? "selected":""}} value="Complete">Complete</option>
                                            </select>
                                            @error('state')
                                  ...
                                  <div class="user_form_content">
                                    ...
                                    <div class="user_form_content">
                                        ...
                                        <div class="user_input_form">
                                            <input type="email" class="form-control" id="created_by" value="{{$ticket['created_by']}}" name="created_by" readonly autocomplete="created_by" autofocus  placeholder="Created By">
                                            {{-- <input type="text" name="your_input_name" value="{{ generateUniqueString('CI') }}" readonly> --}}
                                    ...
                                    <div class="user_form_content">
                                        ...
                                        <div class="user_input_form">
                                            <input type="text" class="form-control" id="module_name" value="{{$ticket['module_name']}}" name="module_name" autocomplete="module_name" autofocus  placeholder="Module Name">
                                    ...
                                    <div class="user_form_content">
                                        ...
                                        <div class="user_select_form">
                                            <select id="severity" name="severity" class="form-select"
                                                ...
                                                <option {{($ticket['severity']=='Critical')?"selected":""}} value="Critical">Critical</option>
                                                <option  {{($ticket['severity']=='temp1')?"selected":""}} value="temp1">temp1</option>
                                                <option  {{($ticket['severity']=='temp2')?"selected":""}} value="temp2">temp2</option>
                                                <option  {{($ticket['severity']=='temp3')?"selected":""}} value="temp3">temp3</option>
                                            </select>
                                            @error('severity')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="user_form_content">
                                        ...
                                        <div class="user_select_form">
                                            <select id="incident_type" name="incident_type" class="form-select"
                                                ...
                                                <option {{($ticket['incident_type']=='Bug')?"selected":""}} value="Bug">Bug</option>
                                                <option {{($ticket['incident_type']=='temp1')?"selected":""}} value="temp1">temp1</option>
                                                <option {{($ticket['incident_type']=='temp2')?"selected":""}} value="temp2">temp2</option>
                                                <option {{($ticket['incident_type']=='temp3')?"selected":""}} value="temp3">temp3</option>
                                            </select>
                                            @error('incident_type')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="user_form_content">
                                        ...
                                        <div class="user_input_form">
                                            <textarea  class="form-control" id="user_comments" name="user_comments" autocomplete="user_comments" autofocus  >{{$ticket['user_comments']}}</textarea>
                                        </div>
                                    </div>
                                    {{-- <div class="user_form_content">
                                    ...
                                    <div class="user_form_content">
                                        ...
                                        <div class="user_input_form">
                                            <input type="file"  class="form-control" value="{{$ticket['attachments']}}" id="attachments" name="attachments" required autocomplete="name"   >
